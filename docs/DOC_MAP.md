...
| [CREW.md](CREW.md) | Night crew roles; machines propose, humans promote | `scripts/run_crew.py`; `.github/workflows/harvest-openalex.yml`; `drafts/crew-reports/LATEST.md` |
