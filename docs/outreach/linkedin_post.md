...
- **1,124** cross-domain bridges across physics, biology, economics, neuroscience, information theory, complex systems, and 50+ more disciplines
- **1,409** structured open unknowns (0 orphans) — research gaps cataloged per discipline with suggested hypotheses
- **1,275** active hypotheses with proposed experimental tests
...
- A **3,861-node / 4,522-edge** interactive knowledge graph (reproducible build) with public dashboard + JSON API
...
Crosscheck demo (runnable repro): https://kr8zysho3.github.io/Universal-Science-Discovery/dashboard/explainers/b-habitat-percolation-ecology.html#crosscheck
