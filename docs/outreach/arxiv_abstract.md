...
entries governed by formal schemas. The repository currently contains 1,124 cross-domain
bridges, 1,409 open unknowns (zero orphans), and 1,275 falsifiable hypotheses across 55+
scientific domains. We describe the schema design, the reproducible 3,861-node / 4,522-edge
