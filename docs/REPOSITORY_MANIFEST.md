...
| [tests/repo_smoke/test_catalog_regression.py](../tests/repo_smoke/test_catalog_regression.py) | Test | Smoke tests wrapping catalog validation + dashboard/domain regressions | [OPERATING_RHYTHM.md](OPERATING_RHYTHM.md), [.github/workflows/validate-schemas.yml](../.github/workflows/validate-schemas.yml) |
...
| [.github/workflows/validate-schemas.yml](../.github/workflows/validate-schemas.yml) | CI | **`pytest tests/repo_smoke`** — catalog YAML, domain pages, dashboard stat consistency | [schemas/README.md](../schemas/README.md), [OPERATING_RHYTHM.md](OPERATING_RHYTHM.md), [tests/repo_smoke/test_catalog_regression.py](../tests/repo_smoke/test_catalog_regression.py) |
