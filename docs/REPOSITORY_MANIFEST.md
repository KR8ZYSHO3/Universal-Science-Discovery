...
| [docs/USE.md](USE.md) | Guide | Utilization flow (try it / add a question / keep it honest) | [ROADMAP.md](../ROADMAP.md), hub `#start` |
...
| [scripts/export_orphan_xref_panel.py](../scripts/export_orphan_xref_panel.py) | Tool | Writes `api/v1/orphan_xref_panel.json` for the hub xref/orphan hygiene panel | [docs/DEV_DASHBOARD.md](DEV_DASHBOARD.md), `.github/workflows/build-graph.yml` |
