...
- **First screen:** three doors matching [docs/USE.md](../docs/USE.md): **Run the test** / **See how two fields connect** / **Add an open question**. A **fixed top bar** switches destinations (`#/`, `#/map`, `#/search`, `#/add`, `#/more`) instead of one long scroll. Operator “keep it honest” is a footnote. GitHub jargon stays out of the hero. The site browses; it does not edit catalog files.
