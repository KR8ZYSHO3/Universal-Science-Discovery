...
- **First screen:** three doors matching [docs/USE.md](../docs/USE.md). Fixed top bar: **USDR · Map · Search · Add · More**. **Map is full screen** (pathfinder strip + graph). Visitor copy avoids YAML/Git words; operator chrome stays behind More.
