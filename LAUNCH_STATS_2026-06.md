...
- **Open unknowns**: 1,409 (0 orphans)
- **Falsifiable hypotheses**: 1,275
- **Knowledge graph**: 3,861 nodes, 4,522 edges
...
**Total structured catalog entries** (bridges + unknowns + hypotheses + pioneers + breakthrough gaps + phenomenology): **~3,861**
...
"USDR is a git-native, schema-validated, community-governed catalog of scientific unknowns, hypotheses, and cross-domain mathematical bridges. It currently contains 1,124 rigorously structured bridges, 1,409 open unknowns, and 1,275 testable hypotheses across 55+ disciplines — all connected in a 3,861-node knowledge graph with zero orphans and 100% schema compliance."

### For the Preprint Abstract (refresh the numbers section)

"...The repository currently contains **3,861+ structured catalog entries** across **55+** disciplines, including **1,124 cross-domain bridges** that formalise mathematical correspondences between fields that rarely communicate, **1,409** open unknowns, **1,275** falsifiable hypotheses, **18** pioneer profiles, and **24** breakthrough gap analyses (plus phenomenology records). The knowledge graph contains **3,861 nodes** and **4,522 edges** with **0 orphan unknowns**..."

### For Dashboard Hero / OpenGraph (suggested stronger external-facing version)

"Map what science doesn't know yet.

1,124 cross-domain mathematical bridges • 1,409 open unknowns • 1,275 testable hypotheses • 3,861-node knowledge graph
...
- 1,124 rigorously documented cross-domain bridges (with translation tables and literature references)
- 1,409 named, structured open unknowns across 55+ fields
- 1,275 falsifiable hypotheses linked to those unknowns
- A deterministic 3,861-node knowledge graph with zero disconnected entries
