...
|------|-------|-----------|
| Unknowns | 534 | `unknowns-catalog/` |
| Hypotheses | 116 | `hypotheses/active/` |
| Bridges | 100 | `cross-domain/` |
| Pre-formal observations | 1 | `phenomenology/` |
| Knowledge graph nodes | 751 | `docs/knowledge_graph.json` |
| Knowledge graph edges | 619 | `docs/knowledge_graph.json` |
