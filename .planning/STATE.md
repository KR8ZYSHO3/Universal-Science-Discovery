...
- E2 stewards call text finalized (ready to post to Discussions).
...
- Trackers updated + canvas synced. Next: post stewards call (E2), more activations + guide promotion (E4), complete domain registration (E3).
